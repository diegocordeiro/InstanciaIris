...
\begin{center}
\url{https://github.com/SE4AI-UFPI/20261002180_atividade_1.git}
\end{center}
...
resume as métricas do modelo Random Forest treinado em dois momentos e registradas no experimento testeprojeto\_experiments
com MLFlow.
...
A Figura~\ref{fig:dist} apresenta a distribuição das duas características utilizadas no modelo, 
permitindo observar o comportamento dos respectivos valores na amostra analisada. 
A Figura~\ref{fig:corr}, por sua vez, apresenta a correlação entre essas características, possibilitando avaliar 
...
\caption{Distribuição das características sepal\_length e sepal\_width.}
\label{fig:dist}
\end{figure}
