...
**Importante**: O Cookiecutter copia o conteúdo de `cookiecutter-fabricaia/testeprojeto/` para criar o novo projeto. A estrutura gerada será:
...
O Cookiecutter copia o conteúdo de `cookiecutter-fabricaia/testeprojeto/`. Se essa pasta estiver vazia ou incompleta, o projeto gerado terá a mesma estrutura. Este repositório já inclui a estrutura mínima necessária.

**Verificação**: Confirme que o diretório `cookiecutter-fabricaia/testeprojeto/` contém os arquivos e pastas esperados antes de gerar um novo projeto.
