...
async def predict(request: PredictionRequest):
    ...
    try:
        ...
        return PredictionResponse(
            #TODO: ajustar para retornar um valor único em vez de uma lista para previsões de um único exemplo
            # bugfix: retornar um valor único em vez de uma lista para previsões de um único exemplo
